...
try:
    ...
    raise ImportError('Notion requires extra dependencies. Install with `pip install --upgrade embedchain[community]`') from None
...
class NotionLoader(BaseLoader):
    ...
    def load_data(self, source):
        ...
        return {'doc_id': doc_id, 'data': [{'content': text, 'meta_data': {'url': f'notion-{formatted_id}'}}]}
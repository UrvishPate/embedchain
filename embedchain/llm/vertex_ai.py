...
class VertexAILlm(BaseLlm):
    ...
    def __init__(self, config: Optional[BaseLlmConfig]=None):
        try:
            ...
            raise ModuleNotFoundError('The required dependencies for VertexAI are not installed.Please install with `pip install --upgrade "embedchain[vertexai]"`') from None

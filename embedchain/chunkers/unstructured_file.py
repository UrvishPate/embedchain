...
class UnstructuredFileChunker(BaseChunker):
    """
    Chunker for Unstructured file. It inherits from the BaseChunker class.

    :param config: Configuration for the chunker. If not provided, a default configuration is used.
    :type config: Optional[ChunkerConfig]
    """

    def __init__(self, config: Optional[ChunkerConfig]=None):
        """
        Initializes the UnstructuredFileChunker.

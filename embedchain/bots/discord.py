...
try:
    ...
    raise ModuleNotFoundError('The required dependencies for Discord are not installed.Please install with `pip install "embedchain[discord]"`') from None
...
class DiscordBot(BaseBot):
    """
    A class to represent a Discord bot. It is a subclass of BaseBot.
    """

    def __init__(self, *args, **kwargs):
        """
        Initializes the DiscordBot with the given arguments.
        """
        BaseBot.__init__(self, *args, **kwargs)

    def add_data(self, message):
        """
        Adds data from the given message to the bot.

        :param message: The message from which to extract data.
        :type message: str
        :return: A response message indicating the success or failure of the operation.
        :rtype: str
        """
    ...
    def ask_bot(self, message):
        """
        Queries the bot with the given message.

        :param message: The message with which to query the bot.
        :type message: str
    ...
    def start(self):
        """
        Starts the Discord bot using the bot token from the environment variables.
        """

...
try:
    ...
    raise ModuleNotFoundError('The required dependencies for Slack are not installed.Please install with `pip install --upgrade "embedchain[slack]"`') from None
            ...
            if float(message.get('ts')) > float(self.recent_message['ts']):
                ...
                if text.startswith('query'):
                    ...
                    try:
                        ...
                        logging.error(f"Error occurred during 'query' command: {e}")
                    ...
                    try:
                        ...
                        logging.error(f"Error occurred during 'add' command: {e}")
                    except Exception as e:

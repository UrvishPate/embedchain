...
class EmbedChain(JSONSerializable):
    ...
    def add(self, source: Any, data_type: Optional[DataType]=None, metadata: Optional[Dict[str, Any]]=None, config: Optional[AddConfig]=None, dry_run=False):
        """
        ...
        (documents, metadatas, _ids, new_chunks) = self.load_and_embed(data_formatter.loader, data_formatter.chunker, source, metadata, source_hash, dry_run)
    ...
    def load_and_embed(self, loader: BaseLoader, chunker: BaseChunker, src: Any, metadata: Optional[Dict[str, Any]]=None, source_hash: Optional[str]=None, dry_run=False):
        """
    ...
    def retrieve_from_database(self, input_query: str, config: Optional[BaseLlmConfig]=None, where=None, citations: bool=False) -> Union[List[Tuple[str, str, str]], List[str]]:
        """

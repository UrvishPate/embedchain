...
def test_load_data(mocker):
    ...
    expected_data = [{'content': 'content1', 'meta_data': {'url': content}}, {'content': 'content2', 'meta_data': {'url': content}}]
...
def test_load_data_url(mocker):
    ...
    mocker.patch('llama_hub.jsondata.base.JSONDataReader.load_data', return_value=[Document(text='content1'), Document(text='content2')])

...
class TestClient:
    ...
    def test_valid_api_key(self, mock_requests_post):
        ...
        assert client.check_api_key('valid_api_key') is True
    ...
    def test_update_valid_api_key(self, mock_requests_post):
        mock_requests_post.return_value.status_code = 200
        client = Client(api_key='valid_api_key')
        client.update_api_key('new_valid_api_key')
        assert client.get_api_key() == 'new_valid_api_key'
    ...
    def test_save_api_key(self, mock_requests_post):
        ...
        client.save_api_key()
        assert client.get_api_key() == api_key_to_save
    ...
    def test_load_api_key_from_config(self, mocker):
        ...
        client = Client()
        assert client.get_api_key() == 'test_api_key'

...
class TestChromaDbHostsLoglevel(unittest.TestCase):
    ...
    def test_whole_app(self, _mock_add, _mock_ec_retrieve_from_database, _mock_get_answer_from_llm, mock_ec_get_llm_model_answer):
        """
    ...
    def test_add_after_reset(self):
        ...
        app.db.collection.add(embeddings=[[1.1, 2.3, 3.2], [4.5, 6.9, 4.4], [1.1, 2.3, 3.2]], metadatas=[{'chapter': '3', 'verse': '16'}, {'chapter': '3', 'verse': '5'}, {'chapter': '29', 'verse': '11'}], ids=['id1', 'id2', 'id3'])
        app.reset()
...
class TestApp(unittest.TestCase):
    ...
    def test_detect_datatype_youtube(self):
        ...
        self.assertEqual(detect_datatype('https://www.youtube-nocookie.com/watch?v=dQw4w9WgXcQ'), DataType.YOUTUBE_VIDEO)
    ...
    def test_detect_datatype_docs_sitein_path(self):
        ...
        self.assertNotEqual(detect_datatype('file:///var/www/docs/index.html'), DataType.DOCS_SITE)
    ...
    def test_detect_datatype_qna_pair(self):
        self.assertEqual(detect_datatype(('Question?', 'Answer. Content of the string is irrelevant.')), DataType.QNA_PAIR)
    ...
    def test_detect_datatype_qna_pair_types(self):
        ...
        with self.assertRaises(TypeError):
            self.assertNotEqual(detect_datatype(('How many planets are in our solar system?', 8)), DataType.QNA_PAIR)
    ...
    def test_doc_examples_introduction(self):
        ...
        self.assertEqual(detect_datatype('https://navalmanack.s3.amazonaws.com/Eric-Jorgenson_The-Almanack-of-Naval-Ravikant_Final.pdf'), DataType.PDF_FILE)

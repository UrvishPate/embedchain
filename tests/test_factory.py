...
class TestFactories:
    ...
    @pytest.mark.parametrize('provider_name, config_data, expected_class', [('openai', {}, embedchain.llm.openai.OpenAILlm), ('anthropic', {}, embedchain.llm.anthropic.AnthropicLlm)])
